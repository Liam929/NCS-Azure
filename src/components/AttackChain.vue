  <!-- <template>
    <div class="attack-chain">
      <div class="attack-step" v-for="(step, index) in attackData" :key="index">
  ...
  export default {
    data() {
      return {
        attackData: [
          { name: 'Step 1', time: '2023-05-03 12:00:00', result: 'success' },
          { name: 'Step 2', time: '2023-05-03 12:30:00', result: 'timeout' },
          { name: 'Step 3', time: '2023-05-03 13:00:00', result: 'failed' },
          // ...
        ],
      };
    },
  ...
  data() {
    return {
      ...
      attackData: [
        ...
        { name: 'Step 2', time: '2023-05-03 12:30:00', result: 'timeout', details: { command: 'Command 2', description: 'Description 2' } },
